...
if __name__ == "__main__":
    ...
    # xedges = np.arange(0, max(global_rs), 1)
    # yedges = np.linspace(min(global_kappas), max(global_kappas), len(xedges))
    ...
    key_to_callback[ord("T")] = beam
    o3d.visualization.draw_geometries_with_key_callbacks([pcd, line_set],
                                                         key_to_callback)
